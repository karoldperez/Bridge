...
$.extend( Datepicker.prototype, {
	...
	_generateHTML: function( inst ) {
		...
		prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
			"<a id='flecha_previa' class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
		...
		next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
			"<a id='flecha_siguiente' class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							( printDate.getTime() === today.getTime() ? " " + this._currentClass : "" ) ) + "'" + // highlight today (if different)
