...
(function (h) {
    ...
    function ob(a) {
        var b = a.oClasses,
                ...
                e = a.oPreviousSearch,
                f = a.aanFeatures,
                g = '<input type="search" class="search ' + b.sFilterInput + '"/> Buscar ',
                j = d.sSearch,
                j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
                b = h("<div/>", {
                    id: !f.f ? c + "_filter" : null,
                    "class": b.sFilter
                }).append(h("<label id=\"labelSearch\"/>").append(j)),
                f = function () {
                    var b = !this.value ?
                            "" : this.value;
                    b != e.sSearch && (fa(a, {
    ...
    function nb(a) {
        ...
        var i = h("<div class=\"div-label\">  Mostrar  <label></label></div>").addClass(b.sLength);
